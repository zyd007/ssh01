...
<tr ><td colspan="5">
	...
	查询条件	<input type="text" name="con" value="${con }"/>
		...
		<a href="document_listReceive?isRead=0">未读信件</a>
&nbsp;	<a href="document_listReceive?isRead=1">已读信件</a>
</td>
	...
	<s:if test="#ds.totalRecord==0"><tr><td colspan="5">当前没有收到信件</td></tr></s:if>
	<s:else>
<s:iterator value="#ds.datas">
	<tr>
		<td>${title }</td>
		<td><s:date name="createDate" format="yyyy-MM-DD HH:mm:ss"/></td>
		<td>${user.nickname }[${user.department.name }]</td>
		<td>
			<a href="document_showReceive?isRead=${isRead }&id=${id }">查看</a>
		</td>
	</tr>
</s:iterator>
</s:else>
...
<jsp:include page="/inc/pager.jsp">
	...
	<jsp:param value="${ds.totalRecord }" name="items"/>
